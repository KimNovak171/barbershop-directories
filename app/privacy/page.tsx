...
export const metadata: Metadata = {
  title: "Privacy Policy | Barber Shop Directories",
  description:
    "Privacy policy for BarbershopDirectories.com. How we collect, use, and protect your information when you use our barber shop directory.",
  alternates: {
    canonical: "/privacy",
    languages: {
      "en-us": "https://barbershopdirectories.com/privacy",
    },
  },
  openGraph: {
    title: "Privacy Policy | Barber Shop Directories",
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-slate mt-10 max-w-3xl prose-headings:font-semibold prose-headings:text-navy prose-a:text-teal prose-a:no-underline hover:prose-a:underline">
        <section className="space-y-4 text-sm text-slate-700">
          ...
          <p>
            BarbershopDirectories.com (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) operates a directory website that helps clients find and compare barber shops across the United States and Canada. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.
          </p>
          ...
          <p>
            Our directory displays information about barber shops that we obtain from public sources (such as Google Maps) or that is provided by business owners. Listing details (e.g., name, address, phone, website) are shown to help users compare options. If you are a shop owner and wish to update or remove your listing, contact us at hello@directoriesnetwork.com.
          </p>
