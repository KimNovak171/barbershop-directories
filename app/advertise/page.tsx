...
export const metadata: Metadata = {
  ...
  description:
    "Featured and premium listings on BarbershopDirectories.com. Reach clients actively searching for barber shops, barbers, haircuts, and shaves across the United States.",
  alternates: {
    canonical: "/advertise",
    languages: {
      "en-us": "https://barbershopdirectories.com/advertise",
    },
  },
  openGraph: {
    title: "Advertise | Get Your Shop in Front of Clients",
    description:
      "A featured listing puts your shop at the top of your city directory section and in front of high-intent visitors at the moment they are choosing a barber shop or barber.",
    url: "/advertise",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BarbershopDirectories.com advertise page preview",
      },
    ],
  },
};
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <header className="space-y-3">
        ...
        <p className="max-w-3xl text-sm text-slate-600">
          BarbershopDirectories.com is visited by clients actively searching for
          barber shops and haircuts and shaves across the United States. A featured listing puts
          your shop at the top of your city directory section and in front of
          high-intent visitors at the moment they are choosing a barber shop or barber.
        </p>
      </header>
